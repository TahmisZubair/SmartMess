...
const AdminMenuPage = () => {
    ...
    const fetchMenu = async () => {
        try {
            const res = await axios.get("https://smartmess.onrender.com/api/menu/get");
    ...
    const handleAddOrUpdate = async (e) => {
        ...
        try {
            if (editDay) {
                await axios.put(`https://smartmess.onrender.com/api/menu/update/${editDay}`, formData, { withCredentials: true });
                toast.success("Menu updated successfully");
            } else {
                await axios.post("https://smartmess.onrender.com/api/menu/add", formData, { withCredentials: true });
    ...
    const handleDelete = async (day) => {
        try {
            await axios.delete(`https://smartmess.onrender.com/api/menu/delete/${day}`, { withCredentials: true });
