...
const AdminNotice = () => {
  ...
  const fetchNotices = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://smartmess.onrender.com/api/notice/all", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        // Update
        await axios.put(
          `https://smartmess.onrender.com/api/notice/update/${editingId}`,
          form,
          { withCredentials: true }
        );
        ...
        // Create
        await axios.post(
          "https://smartmess.onrender.com/api/notice/create",
          form,
          { withCredentials: true }
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://smartmess.onrender.com/api/notice/delete/${id}`, {
        withCredentials: true,
      });
